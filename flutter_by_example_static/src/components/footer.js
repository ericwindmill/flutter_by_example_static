          ...
          >
            ...
            <a href={"https://www.manning.com/books/flutter-in-action"}>
              ...
              >
                ...
                />
                <h3 style={{ marginRight: rhythm(2), color: colors.white }}>
                  You can get all this content and more in one place. Check out
                  my new book Flutter in Action
                </h3>
              </div>
            </a>
            <div
            ...
            >
              <ul style={{ listStyle: "none", display: "flex" }}>
                ...
                <li>
                  <a href="https://github.com/ericwindmill/flutter_by_example_static">
                    about the project (readme)
                  </a>
                </li>
                <li>
                  <a href="mailto:eric@ericwindmill.com">contact us</a>
                </li>
              </ul>
            </div>
          </div>
